...
def main():
    print("=" * 60)
    print("Baseline SOTA Test: ResNet34 (PyTorch Leakage-Free)")
    print("=" * 60)
    ...
    # 2. Build Absolutely Default ResNet34 Model
    print("\nBuilding Default ResNet34...")

    # Load native PyTorch ResNet34 with ImageNet weights
    ...
    plt.title('ResNet34 Confusion Matrix (Normalized)', fontsize=16, pad=15)
