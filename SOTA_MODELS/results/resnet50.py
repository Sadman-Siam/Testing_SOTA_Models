...
def main():
    print("=" * 60)
    print("Baseline SOTA Test: ResNet50 (PyTorch Leakage-Free)")
    print("=" * 60)
    ...
    # 2. Build Absolutely Default ResNet50 Model
    print("\nBuilding Default ResNet50...")

    # Load native PyTorch ResNet50 with ImageNet weights
    ...
    plt.title('ResNet50 Confusion Matrix (Normalized)', fontsize=16, pad=15)
