...
def main():
    print("=" * 60)
    print("Baseline SOTA Test: EfficientNet-B3 (PyTorch Leakage-Free)")
    print("=" * 60)
    ...
    # 2. Build Absolutely Default EfficientNet-B3 Model
    print("\nBuilding Default EfficientNet-B3...")

    # Load native PyTorch EfficientNet-B3 with ImageNet weights
    ...
    # EfficientNet stores its head in `model.classifier[1]`
    num_ftrs = model.classifier[1].in_features
    model.classifier[1] = nn.Linear(num_ftrs, num_classes) # By default, requires_grad=True
    ...
    plt.title('EfficientNet-B3 Confusion Matrix (Normalized)', fontsize=16, pad=15)
