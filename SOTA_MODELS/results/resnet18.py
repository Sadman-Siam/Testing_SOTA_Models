...
def main():
    print("=" * 60)
    print("Baseline SOTA Test: ResNet18 (PyTorch Leakage-Free)")
    print("=" * 60)
    ...
    # 2. Build Absolutely Default ResNet18 Model
    print("\nBuilding Default ResNet18...")

    # Load native PyTorch ResNet18 with ImageNet weights
    ...
    # PyTorch ResNet already has Global Average Pooling right before this layer.
    num_ftrs = model.fc.in_features
    model.fc = nn.Linear(num_ftrs, num_classes) # By default, this layer requires_grad=True

    model = model.to(device)

    # Define Loss and Optimizer (Only optimize the newly added fc layer)
    ...
    for epoch in range(EPOCHS):
        ...
        for inputs, labels in train_loader:
            ...
            inputs = imagenet_normalize(inputs) # Apply ImageNet normalization
...
# ==========================================
    ...
    plt.title('ResNet18 Confusion Matrix (Normalized)', fontsize=16, pad=15)
