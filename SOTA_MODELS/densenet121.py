...
def main():
    print("=" * 60)
    print("Baseline SOTA Test: DenseNet121 (PyTorch Leakage-Free)")
    print("=" * 60)
    ...
    # 2. Build Absolutely Default DenseNet121 Model
    print("\nBuilding Default DenseNet121...")

    # Load native PyTorch DenseNet121 with ImageNet weights
    ...
    # DenseNet stores its head in `model.classifier`
    ...
    plt.title('DenseNet121 Confusion Matrix (Normalized)', fontsize=16, pad=15)
